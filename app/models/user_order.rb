class UserOrder
  ...
  attr_accessor :zip_number, :dispatch_area_id, :city, :block_number, :building_name, :phone_number, :item_id, :user_id,
                :token, :price
  ...
  def save
    ...
    Address.create(zip_number: zip_number, dispatch_area_id: dispatch_area_id, city: city, block_number: block_number,
